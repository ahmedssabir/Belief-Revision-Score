...
The [Belief Revision](https://www.aaai.org/Papers/Symposia/Spring/2003/SS-03-05/SS03-05-005.pdf) is  a conditional probability model which assumes that the preliminary probability finding is revised to the extent warranted by the hypothesis proof (in our case, the proof is the visual information to revise and select the most related caption to the image). The Belief Revision is written as:
