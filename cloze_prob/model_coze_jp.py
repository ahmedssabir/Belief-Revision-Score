...
# How to run
# python model.py --vis visual_context_label.txt --vis_prob visual_context_prob.txt --c caption.txt
...
from get_probabilities_jp import cloze_prob 
...
input_path= 'Belief-revision_jp.txt'
# re-ranked beam with visual context 
output_path = 'Belief-revision_re-rank_jp.txt'
...
for i in range(len(get_lines(args.c))):
    ...
    print("{} {} {}".format('sim', caption, sim))
    print("{} {} {}".format('score', caption, score))
